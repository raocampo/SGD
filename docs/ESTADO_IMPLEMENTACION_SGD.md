...
- Timeout de sesion por inactividad de `1 hora` operativo en web, con aviso al volver a login.
...
- Completar pruebas reales por rol para `administrador` y `operador` en:
  ...
  - contenido portal,
  - contacto.
- Decidir si el cierre por inactividad debe incorporar advertencia previa de `x minutos` antes de expulsar la sesion.
