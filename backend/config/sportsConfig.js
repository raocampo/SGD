...
const CONFIGS = {
  ...
  basquetbol_3x3: {
    ...
    tiposPunto: [
      { valor: "2pt_campo",  etiqueta: "Canasta (2 pts)", puntos: 2 },
      { valor: "1pt_triple", etiqueta: "Triple (1 pt)",   puntos: 1 },
      { valor: "1pt_libre",  etiqueta: "Tiro libre",      puntos: 1 },
    ],
    tiposInfraccion: [
      { valor: "personal",      etiqueta: "Falta personal",      esGrave: false },
  ...
  basquetbol_minibasket: {
    ...
    suspensiones: {
      maxFaltasPersonalesPorPartido: 5,
      maxFaltasTecnicasPorPartido: 2,
      umbralInfraccionesLeves: null,
      umbralInfraccionesGraves: null,
    },
  ...
  basquetbol_callejero: {
    nombre: "Básquetbol Callejero",
    familia: "basquetbol",
    posiciones: ["Base", "Escolta", "Alero", "Ala-Pívot", "Pívot"],
    jugadoresEnCancha: 5,
    tiempos: 2,
...
const ALIASES = {
  ...
  "basquetbol_3x3":     "basquetbol_3x3",
  "basquetbol 3x3":     "basquetbol_3x3",
  "3x3":                "basquetbol_3x3",
  minibasket:           "basquetbol_minibasket",
  "mini basket":        "basquetbol_minibasket",
  callejero:            "basquetbol_callejero",
  "basquetbol_callejero": "basquetbol_callejero",
};
